...
|----------|-------------|-----------|
| **Android CI** | push/PR em `android/**` | ktlint, testes unitários, build debug (skip até gradlew existir — issue #6) |
...
| **Security** | push/PR + semanal (seg 12h UTC) | gitleaks (CLI), pip-audit |
