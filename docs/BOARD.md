...
| `lane-design-system` | _(nova — sem issue)_ | Tokens de design (cores, tipografia, espaçamento, radii, sombras), mapeamento de **Lucide icons** para usos recorrentes, `docs/design-system.md` + atualizar `android/app/src/main/java/com/joaopedrogms/brainoutapp/ui/theme/{Color,Type,Theme}.kt` | `wt-design-system` | `feature/design-system` | `docs/design-system.md`, `android/app/src/main/java/com/joaopedrogms/brainoutapp/ui/theme/` | 2026-09-17 | **PR #49 aberto** (https://github.com/joao-pedro-gms/BrainOutApp/pull/49) — 15/15 critérios ✅, commit `deb7a32` |
| `lane-diagramacao-datamodels` | _(nova — toca #2, #14, #15)_ | Diagrama ER atualizado (sem auth/usuário), diagrama de camadas offline-only, novos ADRs (0005 sem-auth, 0006 perfil-local), atualizar `docs/modelo-dados.md`, `docs/arquitetura.md`, `docs/adr/` | `wt-diagramacao` | `feature/diagramacao-datamodels` | `docs/modelo-dados.md`, `docs/arquitetura.md`, `docs/adr/0005-*.md`, `docs/adr/0006-*.md` | 2026-09-17 | **PR #50 aberto** (https://github.com/joao-pedro-gms/BrainOutApp/pull/50) — 6/6 critérios ✅, commit `16750b0` |
