...
| `lane-release-v0.2` | — | Tag `v0.2.0`, ajustar workflow `release.yml` se necessário, garantir que APK debug é anexado, validar CI verde | (raiz) | — | `.github/workflows/release.yml` | 2026-09-17 | **tag pendente** |
