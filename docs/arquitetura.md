...
| `viewmodel/` | `com.joaopedrogms.gerenciadeprojetos.viewmodel` | `StateFlow` da UI, eventos |
...
Detalhamento, validação, mensagens de erro e testes em `docs/regras-negocio.md` (a criar em [#11](../issues/11)).
...
Resolução de conflito documentada em `docs/sincronizacao.md` (a criar em [#14](../issues/14)).
...
Decisão registrada em [`docs/adr/0004-integracao-externa.md`](adr/0004-integracao-externa.md) na issue [#15](../issues/15).
...
- Definir estratégia de autenticação no cliente (token storage com EncryptedSharedPreferences) — [#7](../issues/7)
- Definir resolução de conflito de sync — [#14](../issues/14)
- Definir biblioteca de gráficos do dashboard — [#13](../issues/13)
