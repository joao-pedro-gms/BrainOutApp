...
```properties
sdk.dir=/home/joaopgms/Android/Sdk
API_BASE_URL=http://10.0.2.2:8000
KEYSTORE_PATH=/caminho/keystore.jks
KEYSTORE_PASSWORD=***
KEY_ALIAS=***
KEY_PASSWORD=***
```
...
```bash
DATABASE_URL=postgresql://user:pass@localhost:5432/gpa
JWT_SECRET=***
JWT_EXPIRES_MIN=60
...
| `pre-commit` bloqueia secret | Token/key no staged | Remover do arquivo, ver `docs/segredos.md` |
