...
Diagrama ER — versão inicial. Detalhamento em [`arquitetura.md`](../arquitetura.md) e modelagem completa no documento de projeto ([#1](../../issues/1), Apêndice A.1).
...
- **UUID v7** como PK (ordenável por tempo, melhor para sync) — registrar em ADR quando [#14](../../issues/14) for implementada
